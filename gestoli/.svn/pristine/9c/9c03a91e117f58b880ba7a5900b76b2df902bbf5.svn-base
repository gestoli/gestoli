/**
 * ProcesPerduesFormController.java
 */
 ...
 */
public class ProcesPerduesFormController extends SimpleFormController {

    private static Logger logger = Logger.getLogger(ProcesPerduesFormController.class);
    private OliProcessosEjb oliProcessosEjb;
    private OliInfraestructuraEjb oliInfraestructuraEjb;
    private String establimentSessionKey;
    private String seleccioSessionKeyOrigen;   
    private String perduesOli;
    ...
    throws ServletException {
    	...
    	ProcesPerduesCommand pPerdues = (ProcesPerduesCommand)command;
		...
		if (isCreate(request)) {
			try{ 
				...
				oliProcessosEjb.generarPerdida(pPerdues.getData(), pPerdues.getDiposit(), pPerdues.getLitros(), establiment, perduesOli, pPerdues.getDescripcion());
				ControllerUtils.saveMessageInfo(request, missatge("proces.perdues.missatge.ok"));
	    	} catch (Exception e) {
	    		 logger.error("Error processant el Perdues de l'oli", e);
	             ControllerUtils.saveMessageError(request, missatge("proces.perdues.missatge.no"));
			}
		}
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	...
    	ProcesPerduesCommand pPerdues = new ProcesPerduesCommand();
    	...
    	try {
			...
			if (!isFormSubmission(request)) {
					pPerdues.setData(new Date());
			
			} 
					
			Diposit diposit = new Diposit();
			pPerdues.setDiposit(diposit);
			pPerdues.setEstabliment(establiment);
	...
	public void setPerduesOli(String perduesOli) {
		this.perduesOli = perduesOli;
	}
