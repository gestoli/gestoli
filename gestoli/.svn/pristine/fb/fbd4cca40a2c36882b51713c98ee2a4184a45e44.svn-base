 ...
 * 
 */
public class CategoriaInformacioDelegate implements ApplicationContextAware {
	
	private static Logger logger = Logger.getLogger(CategoriaInformacioDelegate.class);
    ...
    public ModelAndView list(
        ...
        try {
        	...
        	Collection llistat = oliInformacioEjb.categoriaInformacioFindAll();
        ...
        for (int i=0; i<ids.length; i++) {
            ...
            if (id != null && !"".equals(id)) {
                try {
                	...
                	oliInformacioEjb.setHibernateTemplate(getHibernateTemplate());
                    if (oliInformacioEjb.existenInformacionesAsociadasCategoria(idInt)) {
                    	...
                    	oliInformacioEjb.setHibernateTemplate(getHibernateTemplate());
                    	oliInformacioEjb.categoriaInformacioEsborrar(idInt);
                    }
                } catch (Exception ex) {
