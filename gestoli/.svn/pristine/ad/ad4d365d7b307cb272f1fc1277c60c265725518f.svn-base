...
<title>
	...
	<script type="text/javascript">
		...
		function crearNoConformitat(id) {
			...
			document.getElementById("idControlNC").value = id;
		...
		function visualitzarNoConformitat(id) {
			...
			document.getElementById("idControlNC").value = "";
			document.getElementById("qualitatNoConformitatForm").submit();
		}
	</script>
...
<form id="formulario" name="aiguaControlOrganolepticVerificacioForm" action="QualitatAiguaControlOrganolepticVerificacioForm.html" method="post" class="extended seguit" onsubmit="">
	...
	<c:if test="${not empty formData.idControlOrganoleptic}">
		<c:import url="comu/CampFormulari.jsp">
			<c:param name="tipus" value="hidden" />
			<c:param name="path" value="formData.idControlOrganoleptic" />
			<c:param name="camp" value="idControl" />
			<c:param name="name" value="idControl" />
		</c:import>
	</c:if> 
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="path" value="formData.idPuntMostreig" />
		<c:param name="title">
			<fmt:message key="qualitat.plaAigua.control.camp.puntMostreig" />
		</c:param>
		<c:param name="camp" value="campo_puntMostreig" />
		<c:param name="name" value="idPuntMostreig" />
		<c:param name="required" value="required" />
		<c:param name="selectItems" value="sortides" />
		<c:param name="selectItemsId" value="id" />
		<c:param name="selectItemsValue" value="nom" />
		<c:param name="selectSelectedValue" value="${formData.idPuntMostreig}" />
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="title">
			<fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.dataControl" />
		</c:param>
	...
	<div id="responsableVerificacioX">
		<c:import url="comu/CampFormulari.jsp">
			...
			<c:param name="title">
				<fmt:message key="qualitat.plaAigua.control.camp.responsable" />
			</c:param>
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="path" value="formData.resultat" />
		<c:param name="title">
			<fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.resultat" />
		</c:param>
		<c:param name="camp" value="campo_resultat" />
		<c:param name="name" value="resultat" />
		<c:param name="required" value="required" />
	...
	<c:if test="${formData.resultat > '1'}">
	<label><fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.resultat.avis" /></label>
	</c:if>
	
	<c:if test="${formData.resultat < '0.2'}">
	<label><fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.resultat.avis2" /></label>
	</c:if>
	
	<div class="separadorH"></div><br/>
	
	<div><label><fmt:message key="qualitat.plaAigua.controlOrganoleptic.propietats" /></label> </div>
	
	<div class="separadorH"></div><br/>
	
	<div class="off" id="olorX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				<c:param name="tipus" value="checkbox" />
				<c:param name="path" value="formData.olor" />
				<c:param name="title">
					<fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.olor" />
				</c:param>
				<c:param name="camp" value="olor" />
				<c:param name="name" value="olor" />
				<c:param name="required" value="required" />
				<c:param name="onclick" value="modificarVisibilidadNoConformidad()"/>
				<c:param name="disabled" value="${disabled}" />
			</c:import>
		</div>
	</div>	
	
	<div class="off" id="colorX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				<c:param name="tipus" value="checkbox" />
				<c:param name="path" value="formData.color" />
				<c:param name="title">
					<fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.color" />
				</c:param>
				<c:param name="camp" value="color" />
				<c:param name="name" value="color" />
				<c:param name="required" value="required" />
				<c:param name="onclick" value="modificarVisibilidadNoConformidad()"/>
				<c:param name="disabled" value="${disabled}" />
			</c:import>
	...
	<div class="off" id="saborX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				<c:param name="tipus" value="checkbox" />
				<c:param name="path" value="formData.sabor" />
				<c:param name="title">
					<fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.sabor" />
				</c:param>
				<c:param name="camp" value="sabor" />
				<c:param name="name" value="sabor" />
				<c:param name="required" value="required" />
				<c:param name="onclick" value="modificarVisibilidadNoConformidad()"/>
				<c:param name="disabled" value="${disabled}" />
			</c:import>
	...
	<div class="off" id="terbolesaX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				<c:param name="tipus" value="checkbox" />
				<c:param name="path" value="formData.terbolesa" />
				<c:param name="title">
					<fmt:message key="qualitat.plaAigua.controlOrganoleptic.camp.terbolesa" />
				</c:param>
				<c:param name="camp" value="terbolesa" />
				<c:param name="name" value="terbolesa" />
				<c:param name="required" value="required" />
				<c:param name="onclick" value="modificarVisibilidadNoConformidad()"/>
				<c:param name="disabled" value="${disabled}" />
			</c:import>
			...
			<div id="listado"><%-- Tabla de resultados --%>
				<div class="layoutSombraTabla ancho">
					...
					<display:table name="formData.noConformitats" id="registre" requestURI="" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho" defaultsort="1" defaultorder="descending">
						...
						<display:setProperty name="export.excel.filename" value="qualitatAiguaControlOrganolepticVerificacio.xls" />
	...
	<div class="botonesForm">
		...
		<div class="btnCorto" 
			...
			onclick="document.location ='QualitatAiguaControlOrganolepticForm.html';"><a
	...
	<form id="deleteForm" action="QualitatAiguaControlOrganolepticForm.html" method="post"
		class="seguit"
		...
		<input id="idControl" name="idControl" value="<c:out value="${idControl}"/>" type="hidden" />
		<input id="action" name="action" value="delete" type="hidden" />
	</form>
	...
	<form id="qualitatNoConformitatForm" action="QualitatNoConformitatForm.html" method="get" class="mini">
		...
		<input id="idControlNC" name="idControl" value="" type="hidden" />
	...
	// <![CDATA[
		...
		function modificarVisibilidadNoConformidad() {
			...
			var terbolesa = document.getElementById("terbolesa");
			if (olor != null && olor.checked
					&& color != null && color.checked
					&& sabor != null && sabor.checked
					&& terbolesa != null && terbolesa.checked) {
