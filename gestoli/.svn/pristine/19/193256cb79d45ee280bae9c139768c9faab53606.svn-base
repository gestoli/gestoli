 ...
 *
 */
public class ConsultaOlivaElaboradaLlistatController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaOlivaElaboradaLlistatController.class);
    ...
    throws ServletException {
    	ConsultaOlivaElaboradaLlistatCommand consulta = (ConsultaOlivaElaboradaLlistatCommand) command;
    	...
    	try {
    		...
    		myModel.put("path", "consultar_olivaElaborada");
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection listaElaboraciones = oliConsultaEjb.olivaElaboradaConsulta(dataInici, dataFi, idEstabliment, false, new Boolean(true));
        		
        		if(!errors.hasErrors()){
        			myModel.put("llistat", listaElaboraciones);
        			myModel.put("trazaTipusOlivaElaborada", trazaTipusOlivaElaborada);
        		}
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaOlivaElaboradaLlistatCommand consulta = (ConsultaOlivaElaboradaLlistatCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaOlivaElaboradaLlistatCommand();
    	else 
...
//    		}    		
	 ...
	 *
	 * @param setTrazaTipusOlivaElaborada La classe a injectar.
	 */
