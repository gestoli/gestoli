 ...
 * 		
 */
public class HistoricDiposit implements java.io.Serializable {
	...
	public HistoricDiposit() {
	}

	public HistoricDiposit(HistoricZona zona, HistoricEstabliment establiment, Boolean actiu,
	...
	public HistoricDiposit(PartidaOli partidaOli, HistoricZona zona,
			HistoricEstabliment establiment, MaterialDiposit materialDiposit,
...
//	}
	...
	public HistoricZona getZona() {
		return this.zona;
	}

	public void setZona(HistoricZona zona) {
		this.zona = zona;
	}

	public HistoricEstabliment getEstabliment() {
		return this.establiment;
	}

	public void setEstabliment(HistoricEstabliment establiment) {
		this.establiment = establiment;
	}
	...
	public HistoricZona getZonaOrigenTrasllat() {
		return zonaOrigenTrasllat;
	}

	public void setZonaOrigenTrasllat(HistoricZona zonaOrigenTrasllat) {
