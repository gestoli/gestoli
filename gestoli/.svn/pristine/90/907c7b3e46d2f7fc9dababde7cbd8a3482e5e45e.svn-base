 ...
 * 		
 */
public class HistoricZona implements java.io.Serializable {
	...
	public HistoricZona(HistoricEstabliment establiment, Boolean actiu, String nom,
	...
	public HistoricZona(HistoricEstabliment establiment, Long idOriginal, Boolean actiu,
			String nom, Boolean fictici, Long imatgePlanol, Boolean defecte,
			String observacions, Set diposits, Boolean defecteTrasllat) {
		this.establiment = establiment;
