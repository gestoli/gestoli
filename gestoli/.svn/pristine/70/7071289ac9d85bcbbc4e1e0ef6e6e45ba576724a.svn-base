 ...
 *
 */
public class ProcesRetirarEtiquetesController extends SimpleFormController {
	private static Logger logger = Logger.getLogger(ProcesRetirarEtiquetesController.class);
	private OliInfraestructuraEjb oliInfraestructuraEjb;
    private String rolDoControl;
	private HibernateTemplate hibernateTemplate;
	private String esAdministracioRequestKey;
	private String esDoGestorRequestKey;
	private String esEstAdministrador;
    ...
    protected Map referenceData(
        ...
        try {
    		...
    		if (request.getAttribute(esDoGestorRequestKey) != null || request.getAttribute(esAdministracioRequestKey) != null || request.isUserInRole(rolDoControl) || request.isUserInRole(rolEstAdministrador)) {
    			if(request.getParameter("idEstabliment")!= null && !request.getParameter("idEstabliment").equals("") ){
                	...
                	String establimentNom = oliInfraestructuraEjb.establimentAmbId(idEstabliment).getNom();
	...
	public void setEsEstAdministrador(String esEstAdministrador) {
		this.esEstAdministrador = esEstAdministrador;
	}
