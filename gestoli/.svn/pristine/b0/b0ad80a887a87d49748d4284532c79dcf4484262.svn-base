 ...
 * 
 */
public class DesferPendentAnaliticaFormController extends SimpleFormController {
	private static Logger logger = Logger
			.getLogger(DesferPendentAnaliticaFormController.class);
	...
	public ModelAndView onSubmit(HttpServletRequest request,
		...
		DesferPendentAnaliticaCommand desferPendentAnaliticaCommand = (DesferPendentAnaliticaCommand) command;
		...
		if (isCreate(request)) {
			try {
				...
				Diposit diposit = oliInfraestructuraEjb.dipositAmbId(desferPendentAnaliticaCommand.getIdDiposit());

				oliInfraestructuraEjb.setHibernateTemplate(getHibernateTemplate());
				establiment = oliInfraestructuraEjb.establimentAmbId(desferPendentAnaliticaCommand.getIdEstabliment());
				...
				ControllerUtils.saveMessageInfo(request, missatge("desferPendentAnalitica.missatge.crear.ok"));
			} catch (Exception ex) {
				logger.error("Error creant el analitica", ex);
				ControllerUtils.saveMessageError(request,
						missatge("desferPendentAnalitica.missatge.crear.no"));
			}
		}
	...
	protected Map referenceData(HttpServletRequest request, Object command, Errors errors) throws Exception {
		...
		myModel.put("path", "desferPendentAnalitica");
	...
	protected Object formBackingObject(HttpServletRequest request) throws ServletException {
		...
		DesferPendentAnaliticaCommand analitica =  new DesferPendentAnaliticaCommand();
