 ...
 * @author Raul Morales
 */
public class ConsultaDeclaracioMensualFormController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaDeclaracioMensualFormController.class);
    ...
    protected Map referenceData(
    	...
    	try {
	        ...
	        ConsultaDeclaracioMensualCommand consulta = (ConsultaDeclaracioMensualCommand)command;
