 ...
 * generated in the es.caib.gestoli.front.sistra.ws package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.gestoli.front.sistra.ws
     * 
     */
