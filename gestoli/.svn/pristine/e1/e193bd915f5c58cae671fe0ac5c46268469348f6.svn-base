 ...
 */
public class ConsultaHistoriaDipositEstablimentDelegate implements ApplicationContextAware {
	private static Logger logger = Logger.getLogger(ConsultaHistoriaDipositEstablimentDelegate.class);
