...
<form id="formulario" action="ConsultaOliComercialitzatEstablimentLlistat.html" method="post" class="extended seguit">
<fieldset>
...
<display:table name="llistat" requestURI="" id="establiment" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoAncho selectable" decorator="subtotaler">
	<display:column titleKey="establiment.camp.nom" sortable="true" sortProperty="nom">
		<a href="ConsultaOliComercialitzatLlistat.html?idEstabliment=<c:out value="${establiment[0]}"/>&amp;fromEstabliment=true&amp;dataInici=${di}&amp;dataFi=${df}"><c:out value="${establiment[1]}"/></a>
	</display:column>
