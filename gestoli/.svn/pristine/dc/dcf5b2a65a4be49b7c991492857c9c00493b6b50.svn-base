 ...
 *
 */
public class ConsultaOliComercialitzatLlistatController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaOliComercialitzatLlistatController.class);
    ...
    throws ServletException {
    	ConsultaOliComercialitzatLlistatCommand consulta = (ConsultaOliComercialitzatLlistatCommand) command;
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection lista = oliConsultaEjb.getSortidaLotVendaEntreDiasEnEstablecimiento(dataInici, dataFi, idEstabliment);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaOliComercialitzatLlistatCommand consulta = (ConsultaOliComercialitzatLlistatCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaOliComercialitzatLlistatCommand();
    	else 
