...
<display:table name="llistat" requestURI="" id="establiment" export="true"
 ...
 class="listadoEstrecho selectable">
	<display:column titleKey="establiment.camp.nom" sortable="true" sortProperty="nom">
		<a href="ConsultaOlivaElaboradaLlistat.html?idEstabliment=<c:out value="${establiment.id}"/>&amp;fromEstabliment=true"><c:out value="${establiment.nom}" /></a>
	</display:column>
	...
	<display:setProperty name="export.xml" value="false" />
   	...
   	<display:setProperty name="export.excel.filename" value="Oli_elaborat.xls" />
