 ...
 */
public class GestorDocumentalGestionarDocumentValidator implements Validator {
	...
	public boolean supports(Class clazz) {
		return clazz.equals(GestorDocumentalGestionarDocumentCommand.class);
	}
	...
	public void validate(Object obj, Errors errors) {
		...
		GestorDocumentalGestionarDocumentCommand command = (GestorDocumentalGestionarDocumentCommand) obj;
