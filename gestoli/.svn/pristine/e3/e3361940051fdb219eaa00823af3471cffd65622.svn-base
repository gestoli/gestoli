 ...
 * @author Raul Morales
 */
public class ConsultaAgrupacioConsultesFormController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaAgrupacioConsultesFormController.class);
    ...
    protected Map referenceData(
        ...
        Collection establiments = oliInfraestructuraEjb.establimentCercaTotsActivos(campanyaId);
        ...
        if (estId!=null){ 
        	...
        	try {
    	        ...
    	        ConsultaAgrupacioConsultesCommand consulta = (ConsultaAgrupacioConsultesCommand)command;
            ...
            //Olivicultors de l'establiemnt
            oliConsultaEjb.setHibernateTemplate(getHibernateTemplate());
    		Collection olivicultors = oliConsultaEjb.findOlivicultorsByEstabliment(estId);
    		myModel.put("olivicultors", olivicultors);
            
            myModel.put("path", "consultar_agrupacioconsultes");
            if(request.getParameter("fromEstabliment")!= null && request.getParameter("fromEstabliment").equalsIgnoreCase("true")){
	        	if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	        		myModel.put("path", "consultar_agrupacioconsultesEstabliment");
