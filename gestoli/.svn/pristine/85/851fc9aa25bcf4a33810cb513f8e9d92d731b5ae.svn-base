...
<div class="layoutSombraTabla ancho"><c:if
...
</c:if> <display:table name="llistat" requestURI="" id="establiment"
	...
	<display:column titleKey="establiment.camp.nom" sortable="true"
		sortProperty="nom">
		<a
			href="ConsultaOliEntradaTrasladoLlistat.html?idEstabliment=<c:out value="${establiment.id}"/>&amp;fromEstabliment=true"><c:out
