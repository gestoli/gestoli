...
<form id="formulario" name="PlaNetejaForm" action="QualitatPlaNetejaVerificacioForm.html" method="post" class="extended seguit" onsubmit="">
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="title">
			<fmt:message key="qualitat.plaNeteja.verificacio.camp.dataVerificacio" />
		</c:param>
	...
	<div class="off" id="satisfactoriX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				...
				<c:param name="title">
					<fmt:message key="qualitat.plaNeteja.verificacio.camp.satisfactoria" />
				</c:param>
		...
		<div id="listado"><%-- Tabla de resultados --%>
			<div class="layoutSombraTabla ancho">
				...
				<display:table name="formData.noConformitats" id="registre" requestURI="" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho" defaultsort="1" defaultorder="descending">
					...
					<display:setProperty name="export.excel.filename" value="qualitatPlaNetejaNoConformitats.xls" />
	...
	<div class="btnCorto" 
		...
		onclick="document.location ='QualitatPlaNetejaVerificacio.html?idNeteja=${idNeteja}';"><a
	...
	<form id="deleteForm" action="QualitatPlaNetejaVerificacio.html" method="post"
		class="seguit"
