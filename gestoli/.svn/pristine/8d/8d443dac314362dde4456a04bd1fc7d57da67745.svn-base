 ...
 * @author Raul Morales
 */
public class ConsultaEntradaFonollController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaEntradaFonollController.class);
    ...
    throws ServletException {
    	ConsultaEntradaFonollCommand consulta = (ConsultaEntradaFonollCommand) command;
...
//    		myModel.put("bodegaId", consulta.getBodega());
    		...
    		myModel.put("path", "consultar_entradesFonoll");
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "consulta_entradaFonollEstabliment");
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection llistat = oliConsultaEjb.entradesFonoll(dataInici, dataFi, idEstabliment);;
...
//        	ControllerUtils.saveMessageError(request, "No s'ha obtingut cap registre");
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaEntradaFonollCommand consulta = (ConsultaEntradaFonollCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaEntradaFonollCommand();
    	else 
...
//    		}
	...
	/**
	 * Metodo 'setEsOlivaTaulaRequestKey'
	 * @param esOlivaTaulaRequestKey La classe a injectar.
	 */
