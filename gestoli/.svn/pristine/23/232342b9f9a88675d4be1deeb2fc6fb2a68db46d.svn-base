 ...
 *
 */
public class OlivicultorDelegate implements ApplicationContextAware {
...
//                    oliInfraestructuraEjb.setHibernateTemplate(getHibernateTemplate());
//                    if (oliInfraestructuraEjb.existenFincasAsociadasOlivicultores(lid)) {
//                    	ControllerUtils.saveMessageError(request, missatge("olivicultor.missatge.esborrar.no.finques", request));
//                    } else {
...
//                    }
                    ...
                    ControllerUtils.saveMessageError(request, missatge("olivicultor.missatge.esborrar.no", request));
                }
            }
        }
