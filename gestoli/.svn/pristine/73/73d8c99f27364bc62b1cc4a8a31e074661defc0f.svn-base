 ...
 * @author Raul Morales
 */
public class AgenciaOliDeclaracioMensualFormController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(AgenciaOliDeclaracioMensualFormController.class);
    ...
    protected Map referenceData(
    	...
    	try {
	        ...
	        AgenciaOliDeclaracioMensualCommand consulta = (AgenciaOliDeclaracioMensualCommand)command;
