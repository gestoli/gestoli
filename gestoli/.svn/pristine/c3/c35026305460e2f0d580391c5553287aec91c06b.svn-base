...
public class GenerarPdfDocRendimentWeb extends AbstractPdfView {
	private static Logger logger = Logger.getLogger(GenerarPdfDocRendimentWeb.class);
	...
	protected void buildPdfDocument(
		...
		Establiment establiment = oliFrontOfficeEjb.establimentAmbId(new Long (idEstabliment));
		Elaboracio elaboracioOli = oliFrontOfficeEjb.elaboracioAmbId(new Long(idElaboracio), true);
		String entradesDiposit = oliFrontOfficeEjb.findResumEntradaDiposiOliByElaboracio(new Long(idElaboracio));
		String sortidesOlivicultor = oliFrontOfficeEjb.findResumsortidaOlivicultorByElaboracio(new Long(idElaboracio));
