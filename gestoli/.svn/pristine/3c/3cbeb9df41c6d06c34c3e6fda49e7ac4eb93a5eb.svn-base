...
<html>
	...
	<body>
		<div id="listado" style="padding-left:30px;"><!-- Tabla de resultados -->
			...
			<div class="layoutSombraTabla ancho">
				...
				<h3><fmt:message key="devolucio.sortida.lot"/></h3>
				...
				<display:table name="lots" requestURI="" id="lot" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoAncho selectable">
					<display:column property="vendaData" format="{0,date,dd/MM/yyyy}" titleKey="sortidaLot.camp.data" sortable="true" sortProperty="vendaData" headerClass="ancho75" url="/DevolucioForm.html" paramId="id" paramProperty="id"/>
					...
					<display:column property="vendaDestinatari" titleKey="sortidaLot.camp.destinatari" headerClass="ancho160" sortable="true">
					...
					<display:column property="botellesDevolucio" titleKey="devolucio.sortida.botelles.tornades" sortable="true" headerClass="ancho100 final"/>
					<display:setProperty name="export.xml" value="false" />
					<display:setProperty name="export.csv" value="false" />
					<display:setProperty name="export.rtf" value="false" />
					<display:setProperty name="export.pdf" value="false" />
					<display:setProperty name="export.excel.include_header" value="true" />
					<display:setProperty name="export.excel.filename" value="devolucions.xls" />
