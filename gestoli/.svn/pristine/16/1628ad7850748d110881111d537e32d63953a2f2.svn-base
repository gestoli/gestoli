 ...
 * 		
 */
public class GestorDocumentalCategoriaInformacio implements java.io.Serializable {
	...
	public GestorDocumentalCategoriaInformacio() {
	}

	public GestorDocumentalCategoriaInformacio(String nom) {
		this.nom = nom;
	}

	public GestorDocumentalCategoriaInformacio(String nom, String descripcio, Set informacions) {
		this.nom = nom;
