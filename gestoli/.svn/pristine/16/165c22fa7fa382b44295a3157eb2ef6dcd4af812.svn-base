 ...
 * 		
 */
public class SortidaPartida implements java.io.Serializable {
	...
	public SortidaPartida() {
	}

	public SortidaPartida(Traza traza, String accioSortida, Boolean valid) {
		this.traza = traza;
		this.accion = accioSortida;
		this.valid = valid;
	}

	public SortidaPartida(Long zona, Traza traza, String accioSortida,
			...
			Double vendaKilos, Pais pais, Provincia provincia, Municipi municipi, Establiment establiment) {
		this.idZona = zona;
		this.traza = traza;
		this.accion = accioSortida;
