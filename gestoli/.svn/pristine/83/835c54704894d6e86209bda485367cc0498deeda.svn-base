...
public class ConsultaLlibreElaboracioOlivaTaulaController extends SimpleFormController {

	private static Logger logger = Logger.getLogger(ConsultaLlibreElaboracioOlivaTaulaController.class);
    		...
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "consulta_elaboracioOlivaEstabliment");
	...
	protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection lista = oliConsultaEjb.registreElaboracioOlivaConsulta(dataInici, dataFi, idEstabliment, true, true);
