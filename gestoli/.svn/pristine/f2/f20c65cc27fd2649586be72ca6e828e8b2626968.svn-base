...
YAHOO.widget.TextNode.prototype.getNodeHtml = function() { 
    ...
    */
	...
	/* 
	 * sandreu@limit.es - Nou desenvolupament per a mostrar els mapes de google i els pdf d'analítiques
	 */
	if (this.href != "javascript:void(0);") {
		...
		if(params[0] == 'map'){
			sb[sb.length] = ' onclick="javascript:window.open(\'Mapa.html?x=' + params[1] + '&y=' + params[2] + '&v=' + escape(params[3]) + '&po=' + params[4] + '&pa=' + params[5] + '&ca=' + params[6] + '\', \'mapa\', \'width=820, height=630\'); return false;"';
		} else if(params[0] == 'pdf'){
			sb[sb.length] = ' onclick="javascript:document.getElementById(\'formAnalitica\').submit();" ';
		} else if(params[0] == 'rend'){
			sb[sb.length] = ' onclick="submitRendiment(\'' + params[1] + '\',\'' + params[2] + '\');" ';
		} else if(params[0] == 'mapweb'){
			sb[sb.length] = ' onclick="javascript:window.open(\'../Mapa.html?x=' + params[1] + '&y=' + params[2] + '&v=' + escape(params[3]) + '&po=' + params[4] + '&pa=' + params[5] + '&ca=' + params[6] + '\', \'mapa\', \'width=820, height=630\'); return false;"';
		} else if(params[0] == 'mapmultweb'){
			sb[sb.length] = ' onclick="javascript:window.open(\'../MapaMultiple.html?idsPlantacions=' + params[1] + '\', \'mapa\', \'width=820, height=630\'); return false;"';
		}
	...
	if (this.href == "javascript:void(0);") {
		var params = (this.data.params).split("#");
		if(params[0] == 'map'){		
			sb[sb.length] = ' <strong>(' + params[7] + ')</strong>';
		} else if(params[0] == 'pdf'){
			sb[sb.length] = ' <strong>(' + params[1] + ')</strong>';
		} else if(params[0] == 'rend'){
			sb[sb.length] = ' <strong>(' + params[3] + ')</strong>';
		} else if(params[0] == 'mapweb'){		
			sb[sb.length] = ' <strong>(' + params[7] + ')</strong>';
		} else if(params[0] == 'mapmultweb'){		
			sb[sb.length] = ' <strong>(' + params[2] + ')</strong>';
		} 
	}
	sb[sb.length] = '</a>';
	sb[sb.length] = '</td>';
...
function submitRendiment(idRend, idEst){
	formulari = document.getElementById('formRendiment');
	document.getElementById('idElaboracio').value = idRend;
	if (document.getElementById('idEstabliment').value == "")
		document.getElementById('idEstabliment').value = idEst;
