...
<form id="formulario" name="ControlPlaguesVerificacioForm" action="QualitatControlPlaguesVerificacioForm.html" method="post" class="extended seguit" onsubmit="">
	...
	<c:if test="${not empty formData.idPlaga}">
		<c:import url="comu/CampFormulari.jsp">
			<c:param name="tipus" value="hidden" />
			<c:param name="path" value="formData.idPlaga" />
			<c:param name="camp" value="idPlaga" />
			<c:param name="name" value="idPlaga" />
		</c:import>
	</c:if> 
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="path" value="formData.objectiu" />
		<c:param name="title">
			<fmt:message key="qualitat.controlPlagues.verificacio.camp.objectiu" />
		</c:param>
		<c:param name="camp" value="campo_objectiu" />
		<c:param name="name" value="objectiu" />
		<c:param name="required" value="required" />
		<c:param name="selectItems" value="plagaObjectiu" />
		<c:param name="selectItemsId" value="id" />
		<c:param name="selectItemsValue" value="nom" />
		<c:param name="selectSelectedValue" value="${formData.objectiu}" />
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="title">
			<fmt:message key="qualitat.controlPlagues.verificacio.camp.dataVerificacio" />
		</c:param>
	...
	<div id="responsableVerificacioX">
		<c:import url="comu/CampFormulari.jsp">
			...
			<c:param name="title">
				<fmt:message key="qualitat.controlPlagues.verificacio.camp.responsable" />
			</c:param>
	...
	<div class="off" id="satisfactoriX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				...
				<c:param name="title">
					<fmt:message key="qualitat.controlPlagues.verificacio.camp.satisfactori" />
				</c:param>
		...
		<div id="listado"><%-- Tabla de resultados --%>
			<div class="layoutSombraTabla ancho">
				...
				<display:table name="formData.noConformitats" id="registre" requestURI="" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho" defaultsort="1" defaultorder="descending">
					...
					<display:setProperty name="export.excel.filename" value="qualitatControlPlaguesNoConformitats.xls" />
	...
	<div class="btnCorto" 
		...
		onclick="document.location ='QualitatControlPlaguesVerificacio.html?idPlaga=${idPlaga}';"><a
	...
	<form id="deleteForm" action="QualitatControlPlaguesVerificacio.html" method="post"
		class="seguit"
