...
<form id="formulario" action="CategoriaInformacioForm.html"
...
<div id="cancelarForm" class="btnCorto"
	...
	onclick="document.location ='CategoriaInformacio.html';"><a
...
<form id="deleteForm" action="CategoriaInformacio.html" method="post"
	class="seguit"
