 ...
 */
public class ConsultaTrasabilitatOlivicultorLlistatValidator implements Validator {
    ...
    public boolean supports(Class clazz) {
        return clazz.equals(ConsultaTrasabilitatOlivicultorLlistatCommand.class);
    }
