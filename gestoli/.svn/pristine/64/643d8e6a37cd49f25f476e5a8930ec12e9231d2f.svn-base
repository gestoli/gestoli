 ...
 */
public class ConsultaMovimentsEntreEstablimentsLlistatValidator implements Validator {
    ...
    public boolean supports(Class clazz) {
        return clazz.equals(ConsultaMovimentsEntreEstablimentsLlistatCommand.class);
    }
