...
<title>Gest-OLI - Datos Campañas</title>
...
<div id="cercaIdMicroweb">
	...
	<div class="cercaId">
		...
		<h2 class="microweb">Datos Campañas</h2>
		<br />
		<h3>Introduce las fechas a consultar:</h3>
		...
		<p>
			...
			<div id="divIdFordataInici" class=" conMargen campoForm165 required">
					...
					<label for="dataInici">Fecha inicio</label>
			...
			<div id="divIdFordataFi" class=" campoForm165 required">
					...
					<label for="dataFi">Fecha fin</label>
					<div class="bordeInput">
	...
	<div class="layoutSombraTabla ancho">
		<c:if test="${llistat != null && not empty llistat}">
			...
			<display:table name="llistat" requestURI="" id="registre" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoAncho ancho600">
				...
				<display:column title="Campaña" headerClass="ancho150" sortable="false">
					${registre.camp}
				</display:column>
				<display:column title="Cantidad" headerClass="ancho100 final" sortable="false">
					${registre.valor}
				</display:column>
