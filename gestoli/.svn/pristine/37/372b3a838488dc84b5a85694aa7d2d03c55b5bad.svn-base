 ...
 * 		
 */
public class HistoricDescomposicioPlantacio implements java.io.Serializable {

	private static final long serialVersionUID = 1L;

	private Long id;
	private HistoricPlantacio plantacio;
	...
	public HistoricDescomposicioPlantacio() {
	}

	public HistoricDescomposicioPlantacio(HistoricPlantacio plantacio, VarietatOliva varietatOliva,
	...
	public HistoricPlantacio getPlantacio() {
		return this.plantacio;
	}
	public void setPlantacio(HistoricPlantacio plantacio) {
		this.plantacio = plantacio;
	}
