...
<title><c:set var="titol">
	<decorator:title />
</c:set> <fmt:message key="webapp.nom" /><c:if test="${not empty titol}"> - <c:out
		value="${titol}" />
</c:if></title>
...
<div id="layoutPagina" class="extranet">

<!-- Menu superior -->
<c:if test="${entornProves == 'si'}">
<div id="menuSuperiorProva"><jsp:include page="../plantilla/Menu.jsp" /></div>
</c:if>

<c:if test="${entornProves == 'no'}">
<div id="menuSuperior"><jsp:include page="../plantilla/Menu.jsp" /></div>
</c:if>

<!-- Cabecera -->
<c:if test="${entornProves == 'si'}">
<div id="cabeceraGeneralProva">
<h1><a href="<%=request.getContextPath()%>/"> <span>Gest-OLI</span></a></h1>
</div>
</c:if>
...
<!-- Linea de path -->
<div id="pathCabecera"><jsp:include page="../plantilla/Path.jsp" />
</div>
...
<!-- Pie de pagina -->
<div id="pieGeneral"><jsp:include page="../plantilla/Pie.jsp" />
</div>
