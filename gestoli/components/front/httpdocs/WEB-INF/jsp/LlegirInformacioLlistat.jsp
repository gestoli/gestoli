	...
	<tbody>
		...
		<c:if test="${not empty esOlivaTaula}">
			<tr class="odd alt">
				...
				<td>9,7 Mb</td>
				<td style="background-image: none; " class="ancho32 final">
					<a href="http://gestoli.cat/descarregues/presentacions/GEST-OLI%20-%20Manual%20d'usuari%20-%20Oliva%20de%20taula.pdf" onclick="window.open(this.href); return false;" style="text-decoration: none; ">
						<div class="iconoVer" title="<fmt:message key="document.ver"/>"></div>
					</a>
				</td>
			</tr>
