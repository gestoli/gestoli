...
<form id="formulario" name="aiguaControlAnaliticVerificacioForm" action="QualitatAiguaControlAnaliticVerificacioForm.html" method="post" class="extended seguit" onsubmit="">
	...
	<c:if test="${not empty formData.idControlAnalitic}">
		<c:import url="comu/CampFormulari.jsp">
			<c:param name="tipus" value="hidden" />
			<c:param name="path" value="formData.idControlAnalitic" />
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="title">
			<fmt:message key="qualitat.plaAigua.controlAnalitic.camp.dataMostreig" />
		</c:param>
	...
	<c:import url="comu/CampFormulari.jsp">
		<c:param name="tipus" value="calendar" />
		<c:param name="path" value="formData.dataAnalisi" />
		<c:param name="title">
			<fmt:message key="qualitat.plaAigua.controlAnalitic.camp.dataAnalisi" />
		</c:param>
		<c:param name="camp" value="campo_dataAnalisi" />
		<c:param name="name" value="dataAnalisi" />
		<c:param name="required" value="required" />
		<c:param name="maxlength" value="10" />
		<c:param name="aclaracio">
			<fmt:message key="proces.aclaracio.formatdata" />
			...
			<div id="listado"><%-- Tabla de resultados --%>
				<div class="layoutSombraTabla ancho">
					...
					<display:table name="formData.noConformitats" id="registre" requestURI="" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho" defaultsort="1" defaultorder="descending">
						...
						<display:setProperty name="export.excel.filename" value="qualitatAiguaControlAnaliticVerificacio.xls" />
	...
	<div class="botonesForm">
		...
		<div class="btnCorto" 
			...
			onclick="document.location ='QualitatAiguaControlAnaliticForm.html';"><a
	...
	<form id="deleteForm" action="QualitatAiguaControlAnaliticForm.html" method="post"
		class="seguit"
	...
	// <![CDATA[
		...
		function modificarVisibilidadNoConformidad() {
			var satisfactori = document.getElementById("satisfactori");
			if (satisfactori != null && satisfactori.checked) {
