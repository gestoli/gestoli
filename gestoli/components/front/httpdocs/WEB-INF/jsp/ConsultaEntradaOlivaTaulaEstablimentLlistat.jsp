...
<html>
<head>
	<title><fmt:message key="menu.consultas.entrada_oliva" /></title>
...
<div id="listado">
	<div class="layoutSombraTabla ancho">
		...
		<display:table name="llistat" requestURI="" id="establiment"  sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho selectable">
			<display:column titleKey="establiment.camp.nom" sortable="true" sortProperty="nom">
				<a href="ConsultaEntradaOlivaTaula.html?idEstabliment=<c:out value="${establiment.id}"/>&amp;fromEstabliment=true"><c:out value="${establiment.nom}" /></a>
			</display:column>
	...
	<form name="formulario" action="ConsultaEntradaFonoll.html"></form>
