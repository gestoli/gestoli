...
<form id="formulario" name="PlaMantenimentControlVerificacioForm" action="QualitatPlaMantenimentControlVerificacioForm.html" method="post" class="extended seguit" onsubmit="">
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="title">
			<fmt:message key="qualitat.plaManteniment.control.verificacio.camp.objectiu" />
		</c:param>
	...
	<c:import url="comu/CampFormulari.jsp">
		...
		<c:param name="title">
			<fmt:message key="qualitat.plaManteniment.control.verificacio.camp.dataVerificacio" />
		</c:param>
	...
	<div id="responsableVerificacioX">
		<c:import url="comu/CampFormulari.jsp">
			...
			<c:param name="title">
				<fmt:message key="qualitat.plaManteniment.control.verificacio.camp.responsable" />
			</c:param>
	...
	<div class="off" id="satisfactoriX">
		<div class="etiqueta conMargen <c:if test="${not empty status.errorMessage}"> error</c:if>">
			<c:import url="comu/CampFormulari.jsp">
				...
				<c:param name="title">
					<fmt:message key="qualitat.plaManteniment.control.verificacio.camp.satisfactori" />
				</c:param>
		...
		<div id="listado"><%-- Tabla de resultados --%>
			<div class="layoutSombraTabla ancho">
				...
				<display:table name="formData.noConformitats" id="registre" requestURI="" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho" defaultsort="1" defaultorder="descending">
					...
					<display:setProperty name="export.excel.filename" value="qualitatPlaMantenimentControlNoConformitats.xls" />
