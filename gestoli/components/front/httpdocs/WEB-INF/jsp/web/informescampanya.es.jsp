...
<title>Gest-OLI - Informes Campañas</title>
...
<div id="cercaIdMicroweb">
	<div class="cercaId">
		...
		<h2 class="microweb">Informes Producción</h2>
			...
			<div id="listado"><%-- Tabla de resultados --%>
				<div class="layoutSombraTabla ancho">
					...
					<display:table name="informesProduccio" requestURI="" id="registre" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho ancho600">
						<display:column property="campanya" title="Campaña" headerClass="ancho150" sortable="false" />
						<display:column sortable="false" title="Documento" headerClass="ancho32 final">
		...
		<c:otherwise>
			En estos momentos no hay ningún informe de Producción disponible
		</c:otherwise>
		</c:choose>
		
		<br /><br /><br />
		
		<h2 class="microweb">Informes Comercialización</h2>
			...
			<div class="layoutSombraTabla ancho">
				<c:if test="${informesComercialitzacio != null && not empty informesComercialitzacio}">
					...
					<display:table name="informesComercialitzacio" requestURI="" id="registre" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho ancho600">
						<display:column property="any" title="Año" headerClass="ancho150" sortable="false" />
						<display:column sortable="false" title="Documento" headerClass="ancho32 final">
							<a href="../web/ArxiuMostrarWeb.html?id=<c:out value="${registre.document}"/>&download=true">
								<div class="exportPDFWidth16" title="Document"></div>
							</a>
		...
		<c:otherwise>
			En estos momentos no hay ningún informe de Comercialización disponible
		</c:otherwise>
		</c:choose>
