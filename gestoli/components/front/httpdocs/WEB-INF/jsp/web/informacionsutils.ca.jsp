...
<h2 class="microweb">Informacions Útils</h2>
...
<c:choose>
						...
						<ul style="list-style-image: url(../img/icons/bullet.gif) ; margin: 0 0 0 20px; padding: 5px 10px 5px 0;">
							<c:forEach var="informacio" items="${informacionsUtils}">
								<li style=" margin: 0; padding: 0;">
									<a href="informacionsutils.ca.html?idioma=ca&amp;id=${informacio.id}" style="list-style-type: disc; font-size: 11px;">
										<STRONG>${informacio.nom}</STRONG>
									</a>
									<br />
	...
	<c:otherwise>
		En aquests moments no hi ha cap informació útil disponible
	</c:otherwise>
</c:choose>
