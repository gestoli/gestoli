...
<h2 class="microweb">Noticia</h2>
		...
		<tr>
			...
			<td>
				<c:if test="${not empty noticia.imatgePrincipal}">
					<img src="ArxiuMostrarWeb.html?id=${noticia.imatgePrincipal}" width="" height="150" usemap="#nav1" alt="">
				</c:if>
			</td>
		</tr>
	</table>
	...
	<c:if test="${not empty noticia.imatgeSecundaria}">
		<img src="ArxiuMostrarWeb.html?id=${noticia.imatgeSecundaria}" width="" height="50" usemap="#nav1" alt="">
	</c:if>
