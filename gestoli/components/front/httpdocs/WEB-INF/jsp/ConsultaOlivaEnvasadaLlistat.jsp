...
<html>
<head>
<title><fmt:message key="menu.consultas.oliva_envasada" /></title>
...
<body>
<form id="formulario" action="ConsultaOlivaEnvasadaLlistat.html" method="post" class="extended seguit">
<fieldset>
...
<c:if test="${llista != null && not empty llista}">
	...
	<div class="lotes" style="width: 745px;"><h1><fmt:message key="consulta.olivaEnvasada.titol.llistat" /></h1></div>
	...
	<display:table name="llista" requestURI="" id="envasatOliva" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoAncho selectable noEnlace" decorator="subtotaler" defaultsort="1">
		<display:column titleKey="consulta.oliElaborat.camp.varietatOliva" group="1" headerClass="ancho50">
			<c:if test="${envasatOliva.tipusOlivaTaula==0}">
				<fmt:message key="proces.entradaOlivaTaula.camp.tipus.verda" />
			</c:if>
			<c:if test="${envasatOliva.tipusOlivaTaula==1}">
				<fmt:message key="proces.entradaOlivaTaula.camp.tipus.trencada" />
			</c:if>
			<c:if test="${envasatOliva.tipusOlivaTaula==2}">
		...
		<display:column property="kgOlivaTaula" titleKey="lot.camp.producte" headerClass="ancho20"/>
		<display:column property="litresEnvassats" titleKey="consulta.oliEmbotellat.camp.quantitat" headerClass="ancho75 final" total="true" format="{0,number,#,##0.00} l."/>
	<display:setProperty name="export.xml" value="false" />
   	<display:setProperty name="export.csv" value="false" />
   	<display:setProperty name="export.rtf" value="false" />
   	<display:setProperty name="export.pdf" value="false" />
   	<display:setProperty name="export.excel.include_header" value="true" />
   	<display:setProperty name="export.excel.filename" value="Oliva_Envasada.xls" />
...
<c:if test="${llistat2 != null && not empty llistat2}">
	...
	<div class="lotes" style="width: 745px;"><h1><fmt:message key="consulta.olivaEnvasada.titol.llistat1" /></h1></div>
	<div class="layoutSombraTabla ancho">
	<div class="rellenoInf"></div>
	<div class="rellenoIzq"></div>
	<div class="rellenoDer"></div>
