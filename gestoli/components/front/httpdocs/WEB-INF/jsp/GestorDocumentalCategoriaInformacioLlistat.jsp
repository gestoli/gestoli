...
<div class="layoutSombraTabla ancho"><c:if
...
</c:if> <display:table name="llistat" requestURI="" id="categoriaInformacio" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoAncho selectable">
	<display:column titleKey="categoriaInformacio.camp.nom"
		headerClass="ancho160" sortable="true" sortProperty="nom">
		<a href="GestorDocumentalCategoriaInformacioForm.html?id=<c:out value="${categoriaInformacio.id}"/>"><c:out
			value="${categoriaInformacio.nom}" escapeXml="false" /></a>
	</display:column>
	<display:column titleKey="categoriaInformacio.camp.descripcio"
		headerClass="final" sortable="false">
	...
	<display:setProperty name="export.excel.filename" value="CategoriesInformacio.xls" />
	<display:setProperty name="export.decorated" value="true" />
</display:table></div>

<div class="separadorH"></div>

<form name="formulario" action="GestorDocumentalCategoriaInformacioForm.html"></form>
