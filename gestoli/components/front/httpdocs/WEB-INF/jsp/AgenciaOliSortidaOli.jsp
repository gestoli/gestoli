...
<html>
<head>
<title><fmt:message key="agenciaOli.sortidaOli.titol" /></title>
...
<body>
<form id="formulario" action="AgenciaOliSortidaOli.html" method="post" class="extended seguit">
	<fieldset>
...
<jsp:scriptlet>
	...
	<display:table name="llistat" requestURI="" id="partidaOliva"  export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoAncho noEnlace" decorator="subtotaler" defaultsort="1">
		<display:column titleKey="agenciaOli.sortidaOli.camp.data" headerClass="ancho75" sortable="true" property="[0]" format="{0,date,dd/MM/yyyy}" />
		<display:column titleKey="agenciaOli.sortidaOli.camp.document" sortable="true"  property="[1]" />
		<display:column titleKey="agenciaOli.sortidaOli.camp.kg" sortable="true" property="[2]" format="{0,number,#,##0.00}" />
		<display:column titleKey="agenciaOli.sortidaOli.camp.desti" sortable="true" property="[3]" />
		<%--display:column titleKey="agenciaOli.sortidaOli.camp.nif" sortable="true" property="[4]" /--%>
		...
		<display:setProperty name="export.xml" value="false" />
   		...
   		<display:setProperty name="export.excel.filename" value="Agencia_aceite_sortida_oliva.xls" />
