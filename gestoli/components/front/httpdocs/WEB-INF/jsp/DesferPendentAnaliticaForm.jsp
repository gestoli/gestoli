...
<html>
<head>
<title><fmt:message key="desferPendentAnalitica.titol" /></title>
...
<form id="formulario" name="DesferPendentAnaliticaForm" action="DesferPendentAnaliticaForm.html" method="post" class="extended seguit" onsubmit="">
	...
	<div class="botonesForm">
		<div id="guardarForm" class="btnLargo203"
			onclick="submitForm('formulario')"
			onmouseover="underline('enlaceGuardarForm')"
			onmouseout="underline('enlaceGuardarForm')"><a
			id="enlaceGuardarForm" href="javascript:void(0);"><fmt:message
			key="desferPendentAnalitica.precintar" /></a></div>
	</div>
