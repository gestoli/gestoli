...
<form id="tornarForm" action="GestorDocumentalLlegirInformacio.html"
...
<c:if test="${not empty documentos}">
	...
	<display:table name="documentos" requestURI="" id="document" export="true" sort="list" cellpadding="0" cellspacing="0" class="listadoEstrecho noEnlace">
		<display:column titleKey="document.camp.titol" sortable="true">
			<c:out value="${document.titol}" />
		</display:column>
		<display:column titleKey="document.camp.tamany" headerClass="ancho100" sortable="true">
			<c:out value="${document.arxiuObject.normalizeSize}" />
		</display:column>
		<display:column headerClass="ancho32 final">
			<a href="javascript:void(0);" onclick="window.open('ArxiuMostrar.html?id=<c:out value="${document.arxiu}"/>');return false;">
...
<div class="btnCorto" onclick="window.location='GestorDocumentalLlegirInformacio.html';"
