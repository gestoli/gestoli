 ...
 *
 */
public class ConsultaOlivaTaulaComercialitzadaLlistatController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaOlivaTaulaComercialitzadaLlistatController.class);
    ...
    throws ServletException {
    	ConsultaOlivaTaulaComercialitzadaLlistatCommand consulta = (ConsultaOlivaTaulaComercialitzadaLlistatCommand) command;
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection lista = oliConsultaEjb.getSortidaLotVendaOlivaTaulaEntreDiasEnEstablecimiento(dataInici, dataFi, idEstabliment);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaOlivaTaulaComercialitzadaLlistatCommand consulta = (ConsultaOlivaTaulaComercialitzadaLlistatCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaOlivaTaulaComercialitzadaLlistatCommand();
    	else 
