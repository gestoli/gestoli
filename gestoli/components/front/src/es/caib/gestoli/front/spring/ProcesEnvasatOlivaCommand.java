 ...
 * 
 */
public class ProcesEnvasatOlivaCommand extends Lot {
	...
	Double pH1;
	Double pH2;
	Double quantitatAcidCitric;
	String lotAcidCitric;
	...
	public ProcesEnvasatOlivaCommand() {}

	public ProcesEnvasatOlivaCommand(Lot lot){
