 ...
 * 
 */
public class GestorDocumentalGestionarDocumentDelegate implements ApplicationContextAware {
	
	private static Logger logger = Logger.getLogger(GestorDocumentalGestionarDocumentDelegate.class);
    ...
    public ModelAndView delete(
        ...
        for (int i=0; i<ids.length; i++) {
            ...
            if (id != null && !"".equals(id)) {
                try {
                    ...
                    oliQualitatEjb.setHibernateTemplate(getHibernateTemplate());
                    oliQualitatEjb.documentEsborrar(lid);
                } catch (Exception ex) {
        ...
        String forward = deleteView+"?id="+idInformacio;
