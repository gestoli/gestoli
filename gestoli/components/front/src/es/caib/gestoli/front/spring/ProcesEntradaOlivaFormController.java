...
*/
public class ProcesEntradaOlivaFormController extends SimpleFormController {

	private static Logger logger = Logger.getLogger(ProcesEntradaOlivaFormController.class);
	private OliProcessosEjb oliProcessosEjb;
	private OliInfraestructuraEjb oliInfraestructuraEjb;
	private String seleccioSessionKeyOrigen;
	private String estatOlivaSano;
	private String estatOlivaFermentacioBaixa;
	private String estatOlivaFermentacioMitjana;
	private String estatOlivaFermentacioAlta;
	private String estatOlivaAltresDefectes;
	...
	throws ServletException {
		if ((request.getParameter("olivicultorId") != null) && (!request.getParameter("olivicultorId").equals("app"))) {
			ProcesEntradaOlivaCommand pEntradaOliv = (ProcesEntradaOlivaCommand)command;
			...
			if (pEntradaOliv.getEstatOliva().intValue() == (Integer.valueOf(estatOlivaSano)).intValue()) {
				sana = Boolean.valueOf("true");
			}
			Integer estat = pEntradaOliv.getEstatOliva().intValue();
	...
	throws Exception {
		...
		ProcesEntradaOlivaCommand procesEntradaOlivaCommand = (ProcesEntradaOlivaCommand)command;
		...
		if (idOlivicultor != null) {
			...
			procesEntradaOlivaCommand.setOlivicultorId(idOlivicultor);
		...
		if (paramOlivicultor.equals("app")) {
			...
			if (idOlivicultor != null) {
				...
				for (Object objf : fincas) {
					...
					for (Iterator itp = plantacions.iterator(); itp.hasNext();) {
						...
						oliInfraestructuraEjb.setHibernateTemplate(getHibernateTemplate());
						Collection varietatsPlantacions = oliInfraestructuraEjb.cercaVarietatsOlivaPerPlantacions(""+p.getId());
			...
			myModel.put("estadosOliva", estatsOliva(lang));
	...
	protected Object formBackingObject(HttpServletRequest request) throws ServletException {
		ProcesEntradaOlivaCommand pEntradaOliv = (ProcesEntradaOlivaCommand)request.getSession().getAttribute("pEntradaOliv");
		if (pEntradaOliv == null)
			pEntradaOliv = new ProcesEntradaOlivaCommand();
		else
	 ...
	 * @return
	 */
	private List estatsOliva(String lang) {
		ResourceBundle bundle = ResourceBundle.getBundle("messages", new java.util.Locale(lang));
		List estadosOliva = new ArrayList();
		
		BasicData sana = new BasicData();
		sana.setId(estatOlivaSano);
		sana.setNom(bundle.getString("proces.entradaOliva.camp.estado.sana"));
		estadosOliva.add(sana);
		
		BasicData fermentacioBaixa = new BasicData();
		fermentacioBaixa.setId(estatOlivaFermentacioBaixa);
		fermentacioBaixa.setNom(bundle.getString("proces.entradaOliva.camp.estado.fermentacio.baixa"));
		estadosOliva.add(fermentacioBaixa);
		
		BasicData fermentacioMitjana = new BasicData();
		fermentacioMitjana.setId(estatOlivaFermentacioMitjana);
		fermentacioMitjana.setNom(bundle.getString("proces.entradaOliva.camp.estado.fermentacio.mitjana"));
		estadosOliva.add(fermentacioMitjana);
		
		BasicData fermentacioAlta = new BasicData();
		fermentacioAlta.setId(estatOlivaFermentacioAlta);
		fermentacioAlta.setNom(bundle.getString("proces.entradaOliva.camp.estado.fermentacio.alta"));
		estadosOliva.add(fermentacioAlta);
		
		BasicData altresDefectes = new BasicData();
		altresDefectes.setId(estatOlivaAltresDefectes);
		altresDefectes.setNom(bundle.getString("proces.entradaOliva.camp.estado.altres.defectes"));
		estadosOliva.add(altresDefectes);
	...
	/**
	 * Injecció de la dependència estatOlivaSano
	 *
	 * @param estatOlivaSano La classe a injectar.
	 */
	public void setEstatOlivaSano(String estatOlivaSano) {
		this.estatOlivaSano = estatOlivaSano;
	}

	/**
	 * Injecció de la dependència estatOlivaFermentacioBaixa
	 *  
	 * @param estatOlivaFermentacioBaixa La classe a injectar.
	 */
	public void setEstatOlivaFermentacioBaixa(String estatOlivaFermentacioBaixa) {
		this.estatOlivaFermentacioBaixa = estatOlivaFermentacioBaixa;
	}

	/**
	 * Injecció de la dependència estatOlivaFermentacioMitjana
	 *  
	 * @param estatOlivaFermentacioMitjana La classe a injectar.
	 */
	public void setEstatOlivaFermentacioMitjana(String estatOlivaFermentacioMitjana) {
		this.estatOlivaFermentacioMitjana = estatOlivaFermentacioMitjana;
	}

	/**
	 * Injecció de la dependència estatOlivaFermentacioAlta
	 *  
	 * @param estatOlivaFermentacioAlta La classe a injectar.
	 */
	public void setEstatOlivaFermentacioAlta(String estatOlivaFermentacioAlta) {
		this.estatOlivaFermentacioAlta = estatOlivaFermentacioAlta;
	}

	/**
	 * Injecció de la dependència estatOlivaAltresDefectes
	 *  
	 * @param estatOlivaAltresDefectes La classe a injectar.
	 */
	public void setEstatOlivaAltresDefectes(String estatOlivaAltresDefectes) {
		this.estatOlivaAltresDefectes = estatOlivaAltresDefectes;
	}
