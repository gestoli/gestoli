...
public class QualitatAPPCCFitxaControlDelegate implements ApplicationContextAware {
	
	private static Logger logger = Logger.getLogger(QualitatAPPCCFitxaControlDelegate.class);
   ...
   public ModelAndView list(
       ...
       try {
		...
		ResourceBundle bundle = ResourceBundle.getBundle("messages",new java.util.Locale(lang));
           ...
           ControllerUtils.saveMessageError(request, missatge("qualitat.appcc.fitxaControl.missatge.llistat.no", request));
       }
