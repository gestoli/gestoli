 ...
 * @author Raul Morales
 */
public class AgenciaOliSortidaOliController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(AgenciaOliSortidaOliController.class);
    ...
    throws ServletException {
    	AgenciaOliSortidaOliCommand consulta = (AgenciaOliSortidaOliCommand) command;
...
//    		myModel.put("bodegaId", consulta.getBodega());
    		...
    		myModel.put("path", "agenciaOli_sortidaOli");
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "agenciaOli_sortidaOliEstabliment");
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection listaLots = oliConsultaEjb.getSortidaLotVendaEntreDiasEnEstablecimiento(dataInici, dataFi, idEstabliment);
        		...
        		//Unim les llistes en una sola
        		Collection lista = new ArrayList();
        		
        		for(Iterator it=listaLots.iterator(); it.hasNext();){
        			SortidaLot sl = (SortidaLot)it.next();
        			
        			Object[] o = new Object[5];
        			o[0] = sl.getVendaData(); //Data
        			
        			String document = "";
        			document += (sl.getVendaTipusDocument() != null)?sl.getVendaTipusDocument()+" ":"";
        			document += (sl.getVendaNumeroDocument() != null)?sl.getVendaNumeroDocument():"";
        			
        			o[1] = document; //Document
        			o[2] = sl.getVendaLitres() * 0.916; //Kg venta
        			o[3] = sl.getVendaDestinatari(); //Destinatari
        			o[4] = ""; //NIF / CIF
        			
        			lista.add(o);
        		}
        		
        		for(Iterator it=listaGranel.iterator(); it.hasNext();){
        			...
        			String document = "";
        			document += (sd.getVendaTipusDocument() != null)?sd.getVendaTipusDocument()+" ":"";
        			document += (sd.getVendaNumeroDocument() != null)?sd.getVendaNumeroDocument():"";
        			
        			o[1] =  document ; //Document
        			o[2] = sd.getLitres() * 0.916; //Kg venta
        			o[3] = sd.getDesti(); //Destinatari
        			o[4] = ""; //NIF / CIF
...
//        	ControllerUtils.saveMessageError(request, "No s'ha obtingut cap registre");
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	AgenciaOliSortidaOliCommand consulta = (AgenciaOliSortidaOliCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new AgenciaOliSortidaOliCommand();
    	else 
