 ...
 *
 */
public class AltresConsultesGraficsController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(AltresConsultesGraficsController.class);
    ...
    protected Map referenceData(
    	...
    	myModel.put("path", "consultar_grafics");
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	AltresConsultesGraficsCommand consulta = new AltresConsultesGraficsCommand();
