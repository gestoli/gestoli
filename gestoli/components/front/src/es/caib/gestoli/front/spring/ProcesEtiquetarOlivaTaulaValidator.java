/**
 * ProcesEtiquetarOlivaTaulaValidator.java
 *
 ...
 */
public class ProcesEtiquetarOlivaTaulaValidator implements Validator {
	private static Logger logger = Logger.getLogger(ProcesEtiquetarOlivaTaulaValidator.class);
	...
	public boolean supports(Class clazz) {
		return clazz.equals(ProcesEtiquetarOlivaTaulaCommand.class);
	}
	...
	public void validate(Object obj, Errors errors) {
		try {
			ProcesEtiquetarOlivaTaulaCommand command = (ProcesEtiquetarOlivaTaulaCommand)obj;
