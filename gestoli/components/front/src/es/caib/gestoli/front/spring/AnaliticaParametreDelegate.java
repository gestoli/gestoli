 ...
 */
public class AnaliticaParametreDelegate implements ApplicationContextAware {
	private static Logger logger = Logger.getLogger(AnaliticaParametreDelegate.class);
	...
	public ModelAndView list(
		...
		try {
			...
			Collection llistat = oliInfraestructuraEjb.analiticaParametreLlistat();
    ...
    public ModelAndView delete(
        ...
        if (id != null && !"".equals(id)) {
            try {
            	...
            	oliInfraestructuraEjb.setHibernateTemplate(getHibernateTemplate());
                oliInfraestructuraEjb.analiticaParametreEsborrar(lid);
            } catch (Exception ex) {
