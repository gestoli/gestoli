 ...
 */
public class ProcesSortidaOlivaTaulaFormController extends SimpleFormController {

    private static Logger logger = Logger.getLogger(ProcesSortidaOlivaTaulaFormController.class);
...
//    private String pendentQualificar;
    ...
    throws ServletException {
    	...
    	ProcesSortidaOlivaTaulaCommand pSortida = (ProcesSortidaOlivaTaulaCommand)command;
				...
				if ("d".equals(pSortida.getTipusSortida())) {
					...
					for (int i = 0; i < pSortida.getLot().length; i++){
						...
						if (accio.equals(venda)) {
							...
							if (pSortida.getDesqualificar() != null && pSortida.getDesqualificar().booleanValue()) {
								sortidaLot.setOlivaDO(false);
							} else {
								sortidaLot.setOlivaDO(lot.getOlivaDO());
							}
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	...
    	ProcesSortidaOlivaTaulaCommand pSortida = new ProcesSortidaOlivaTaulaCommand();
