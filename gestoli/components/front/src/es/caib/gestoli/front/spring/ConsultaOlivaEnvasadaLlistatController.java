 ...
 *
 */
public class ConsultaOlivaEnvasadaLlistatController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaOlivaEnvasadaLlistatController.class);
    ...
    throws ServletException {
    	ConsultaOlivaEnvasadaLlistatCommand consulta = (ConsultaOlivaEnvasadaLlistatCommand) command;
    	...
    	try {
    		...
    		myModel.put("path", "consultar_olivaEnvasada");
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "consulta_olivaEnvasadaEstabliment");
...
//        			}
        		...
        		for(Iterator it= llistaLots2.iterator(); it.hasNext();){
        			...
        			if (olivaTaula) {
	        			...
	        			procesLotCommand.setVolum(volum);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaOlivaEnvasadaLlistatCommand consulta = (ConsultaOlivaEnvasadaLlistatCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaOlivaEnvasadaLlistatCommand();
    	else 
