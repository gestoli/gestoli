 ...
 *
 */
public class ConsultaOliEntradaTrasladoLlistatController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaOliEntradaTrasladoLlistatController.class);
    ...
    throws ServletException {
    	ConsultaOliEntradaTrasladoLlistatCommand consulta = (ConsultaOliEntradaTrasladoLlistatCommand) command;
    	...
    	try {
    		...
    		myModel.put("path", "consulta_oliEntradaTraslado");
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "consulta_oliEntradaTrasladoEstabliment");
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection listaTrasllat = oliConsultaEjb.oliEntradaTrasladoConsulta(dataInici, dataFi, idEstabliment);
        	...
        	myModel.put("path", "consultar_oliEntradaTraslado");
        	if(consulta.getFromEstabliment()!= null && consulta.getFromEstabliment().equalsIgnoreCase("true")){
    			Establiment establiment =(Establiment)session.getAttribute(establimentSessionKey);
    			if (establiment==null){
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaOliEntradaTrasladoLlistatCommand consulta = (ConsultaOliEntradaTrasladoLlistatCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaOliEntradaTrasladoLlistatCommand();
    	else 
