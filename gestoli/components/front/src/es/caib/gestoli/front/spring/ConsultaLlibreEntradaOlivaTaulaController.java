 ...
 * @author Raul Morales
 */
public class ConsultaLlibreEntradaOlivaTaulaController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaLlibreEntradaOlivaTaulaController.class);
...
//    		myModel.put("bodegaId", consulta.getBodega());
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		for(Object o: lista){
        			...
        			if (po.getEsOlivaDeTaula())	
        				llistat.addAll(po.getDescomposicioPartidesOlives());
        		}
	...
	public String getEsOlivaTaulaRequestKey() {
		return esOlivaTaulaRequestKey;
	}
