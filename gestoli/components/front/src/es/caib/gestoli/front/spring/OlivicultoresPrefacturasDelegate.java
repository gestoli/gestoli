 ...
 *
 */
public class OlivicultoresPrefacturasDelegate implements ApplicationContextAware {
	private static Logger logger = Logger.getLogger(OlivicultoresPrefacturasDelegate.class);
...
//	private String rolOlivicultor;
    ...
    public ModelAndView list(
        ...
        try {
        	...
        	Collection llistat = oliInfraestructuraEjb.findAllAltaDOByCampanya(campanyaId);
