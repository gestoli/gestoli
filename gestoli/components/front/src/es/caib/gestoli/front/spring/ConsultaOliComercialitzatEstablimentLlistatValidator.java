 ...
 */
public class ConsultaOliComercialitzatEstablimentLlistatValidator implements Validator {
    ...
    public boolean supports(Class clazz) {
        return clazz.equals(ConsultaOliComercialitzatEstablimentLlistatCommand.class);
    }
