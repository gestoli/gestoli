 ...
 *
 */
public class ConsultaBasicaGeneralController extends SimpleFormController {
    ...
    throws ServletException {
    	...
    	if(!"/ConsultaBasicaGeneralList.html".equals(request.getServletPath())){	
			ConsultaBasicaGeneral nova = new ConsultaBasicaGeneral();
			nova.setPartidaNom(cbg.getPartidaNom());
			nova.setLotNom(cbg.getLotNom());
