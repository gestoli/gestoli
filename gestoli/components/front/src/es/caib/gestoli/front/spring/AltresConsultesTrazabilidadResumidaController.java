 ...
 *
 */
public class AltresConsultesTrazabilidadResumidaController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(AltresConsultesTrazabilidadResumidaController.class);
...
//    		Collection lista = oliConsultaEjb.getElaboracionesByEstablecimiento(campanyaId,idEstabliment);
	    	...
	    	Collection lista = oliInfraestructuraEjb.findPartidesOliVisiblesByEstabliment(idEstabliment);
...
//    			idProductor = Long.valueOf(request.getParameter("idProductor"));
//    		}    				
//    		if(idProductor != null) consulta.setIdProductor(idProductor);    		
