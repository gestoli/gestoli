    ...
    throws ServletException {
    	...
    	try {
    		...
    		EtiquetesLot etiquetesLot = new EtiquetesLot(
    				etiquetesLotCommand.getEsEcologic()?"EC":etiquetesLotCommand.getEtiquetaLletra(),
    				etiquetesLotCommand.getEtiquetaInici(),
    				etiquetesLotCommand.getEtiquetaFi(),
    				etiquetesLotCommand.getEsEcologic()?0:etiquetesLotCommand.getCapacitat(),
    				false,
    				false,
    				olivaTaula,
    				oliInfraestructuraEjb.establimentAmbId(etiquetesLotCommand.getIdEstabliment()),
    				etiquetesLotCommand.getEsEcologic());
