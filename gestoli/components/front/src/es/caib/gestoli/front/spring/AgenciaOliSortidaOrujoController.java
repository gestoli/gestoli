 ...
 * @author Raul Morales
 */
public class AgenciaOliSortidaOrujoController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(AgenciaOliSortidaOrujoController.class);
    ...
    throws ServletException {
    	AgenciaOliSortidaOrujoCommand consulta = (AgenciaOliSortidaOrujoCommand) command;
...
//    		myModel.put("bodegaId", consulta.getBodega());
    		...
    		myModel.put("path", "agenciaOli_sortidaOrujo");
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "agenciaOli_sortidaOrujoEstabliment");
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		Collection llistat = oliConsultaEjb.findSortidesOrujoEntreDatesIEstabliment(dataInici, dataFi, idEstabliment, true);
...
//        	ControllerUtils.saveMessageError(request, "No s'ha obtingut cap registre");
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	AgenciaOliSortidaOrujoCommand consulta = (AgenciaOliSortidaOrujoCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new AgenciaOliSortidaOrujoCommand();
    	else 
