 ...
 *
 */
public class ConsultaSortidaOrujoLlistatController extends SimpleFormController {

    /*
     * Objeto para escribir mensajes de log.
     */
	private static Logger logger = Logger.getLogger(ConsultaSortidaOrujoLlistatController.class);
    ...
    throws ServletException {
    	ConsultaSortidaOrujoLlistatCommand consulta = (ConsultaSortidaOrujoLlistatCommand) command;
    	...
    	try {
    		...
    		myModel.put("path", "consultar_sortidaOrujo");
    		if (consulta.getFromEstabliment() != null && consulta.getFromEstabliment().equalsIgnoreCase("true")){	
	    		...
	    		if(request.getParameter("fromEstabliment")!= null){
	    			...
	    			if(establiment.getNom()!= null && !establiment.getNom().equalsIgnoreCase("")){
	    				myModel.put("path", "consulta_sortidaOrujoEstabliment");
    ...
    protected Map referenceData(
        ...
        try {
        	...
        	if (Util.isDataCorrecta(request.getParameter("dataInici"), "dd/MM/yyyy")
        		...
        		lista = oliConsultaEjb.sortidaOrujoConsulta(dataInici, dataFi, idEstabliment, new Boolean(true));
        	...
        	logger.error("Error obtenint llistat de sortida d'orujo", ex);
        }
        return myModel;
    }
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
    	ConsultaSortidaOrujoLlistatCommand consulta = (ConsultaSortidaOrujoLlistatCommand)request.getSession().getAttribute("consulta");
    	if (consulta == null) 
    		consulta = new ConsultaSortidaOrujoLlistatCommand();
    	else 
