...
public class ZonaDao {
	private static Logger logger = Logger.getLogger(ZonaDao.class);
	...
	public Collection findAll() throws InfrastructureException {
		...
		try {
			...
			col = getHibernateTemplate().find("from Zona as zon order by zon.nom");			
	...
	public Zona getById(Long id) throws InfrastructureException {
		...
		try {
			...
			String q = "from Zona as zon where zon.id = '"+id+"'";
	...
	public Boolean existenZonasActiusEnEstabliment(Long establimentId) throws InfrastructureException {
		...
		try {
			...
			String q = "select count (zon.id) from Zona zon " +
			"where zon.establiment.id = " + establimentId + " " +
			"and zon.actiu = 'true' ";
			zonas = getHibernateTemplate().find(q);
	...
	public boolean zonaFicticia(Long id) throws InfrastructureException {
		...
		try {
			...
			String q = "select zon.fictici from Zona zon " +
			"where zon.id = " + id + " ";
			zona =  getHibernateTemplate().find(q);
	 ...
	 * @throws InfrastructureException
	 */
	public void makePersistent(Zona zona) throws InfrastructureException {
		try {
	 ...
	 * @throws InfrastructureException
	 */
	public void makePersistent(Zona zona, Session session) throws InfrastructureException {
		try {
			logger.debug("makePersistent ini");
	 ...
	 * @throws InfrastructureException
	 */
	public void makeTransient(Zona zona)
	throws InfrastructureException {
		try {
