 ...
 * 		
 */
public class Plantacio implements java.io.Serializable {
	...
	public Plantacio(Finca finca, Boolean actiu, Municipi municipi,
	...
	public Plantacio(Finca finca, Long idOriginal, Boolean actiu,
